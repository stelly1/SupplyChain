(function e(t, n, r) {
...
})(
  {
    1: [
          ...
          var contract = (function (module) {
            ...
            var Utils = {
              ...
              decodeLogs: function (C, instance, logs) {
                return logs
                  .map(function (log) {
                    ...
                    var argTopics = logABI.anonymous
                      ? copy.topics
                      : copy.topics.slice(1);
                    var indexedData =
                      "0x" +
                    ...
                    Object.keys(copy.args).forEach(function (key) {
                      ...
                      if (val.constructor.isBN) {
                        copy.args[key] = C.web3.toBigNumber(
                          "0x" + val.toString(16)
                        );
                      }
                    });
              ...
              promisifyFunction: function (fn, C) {
                ...
                return function () {
                  ...
                  if (
                    Utils.is_object(last_arg) &&
                    !Utils.is_big_number(last_arg)
                  ) {
                    tx_params = args.pop();
                  }
                    ...
                    return new Promise(function (accept, reject) {
                      var callback = function (error, tx) {
                        ...
                        var make_attempt = function () {
                          C.web3.eth.getTransactionReceipt(
                            tx,
            ...
            function Contract(contract) {
              ...
              this.sendTransaction = Utils.synchronizeFunction(
                function (tx_params, callback) {
                  ...
                  constructor.web3.eth.sendTransaction.apply(
            ...
            Contract._static_methods = {
              setProvider: function (provider) {
                if (!provider) {
                  throw new Error(
                    "Invalid provider passed to setProvider(); provider is " +
                      provider
                  );
                }
              ...
              detectNetwork: function () {
                ...
                return new Promise(function (accept, reject) {
                  ...
                  self.web3.version.getNetwork(function (err, result) {
                    ...
                    var uris = Object.keys(self._json.networks).filter(
                      function (network) {
      ...
      { "ethjs-abi": 7, "truffle-blockchain-utils": 15, web3: 5 },
    ],
    2: [
      function (require, module, exports) {
        ...
        contract.fromSolJS = function (
          soljs_abstraction,
          ignore_default_network
        ) {
          ...
          Object.keys(soljs_abstraction.all_networks).forEach(function (
            network_name
          ) {
      ...
      { "./contract.js": 1, "truffle-contract-schema": 16 },
    ],
    3: [
      function (require, module, exports) {
        "use strict";
  ...
  */
        ...
        (function (Buffer) {
          ...
          function encodeParams(types, values) {
            if (types.length !== values.length) {
              throw new Error(
                "[ethjs-abi] while encoding params, types/values mismatch, types length " +
                  types.length +
                  " should be " +
                  values.length
              );
          ...
          function encodeMethod(method, values) {
            var signature =
              method.name +
              "(" +
              utils.getKeys(method.inputs, "type").join(",") +
              ")";
            var signatureEncoded =
              "0x" +
              new Buffer(utils.keccak256(signature), "hex")
                .slice(0, 4)
                .toString("hex");
            var paramsEncoded = encodeParams(
              utils.getKeys(method.inputs, "type"),
              values
            ).substring(2);
    ...
    8: [
            ...
            return {
              ...
              decode: function decodeFixedBytes(data, offset) {
                ...
                return {
                  consumed: 32,
                  value:
                    "0x" + data.slice(offset, offset + length).toString("hex"),
                };
              },
            };
          }
          ...
          var coderAddress = {
            ...
            decode: function decodeAddress(data, offset) {
              ...
              return {
                consumed: 32,
                value:
                  "0x" + data.slice(offset + 12, offset + 32).toString("hex"),
              };
            },
          };
      ...
      { "bn.js": 4, buffer: 6, "js-sha3": 11, "number-to-bn": 12 },
    ],
    9: [
      function (require, module, exports) {
      ...
      function (require, module, exports) {
        (function (process, global) {
          ...
          (function (root) {
            ...
            var COMMON_JS =
              !root.JS_SHA3_TEST && typeof module == "object" && module.exports;
            ...
            for (var i = 0; i < algorithms.length; ++i) {
              ...
              for (var j = 0; j < bits.length; ++j) {
                methods[algorithm.name + "_" + bits[j]] =
                  algorithm.createMethod(bits[j], algorithm.padding);
              }
            }
    ...
    16: [
      function (require, module, exports) {
        ...
        var TruffleSchema = {
          ...
          generateBinary: function (options, existing_binary, extra_options) {
            ...
            existing_binary.contract_name =
              options.contract_name ||
              existing_binary.contract_name ||
              "Contract";
            existing_binary.default_network =
              options.default_network || existing_binary.default_network;

            existing_binary.abi = options.abi || existing_binary.abi;
            existing_binary.unlinked_binary =
              options.unlinked_binary || existing_binary.unlinked_binary;
            ...
            if (
              ...
              existing_binary.unlinked_binary =
                "0x" + existing_binary.unlinked_binary;
            }
            ...
            Object.keys(options.networks).forEach(function (network_id) {
              existing_binary.networks[network_id] =
                options.networks[network_id];
            });
              ...
              existing_binary.abi.forEach(function (item) {
                ...
                var signature =
                  ...
                  item.inputs
                    ...
                    .join(",") +
                  ")";
                network.events["0x" + sha3(signature, { outputLength: 256 })] =
                  item;
              });
            ...
            Object.keys(existing_binary.networks).forEach(function (
              network_id
            ) {
            ...
            if (extra_options.dirty !== false) {
              ...
              existing_binary.updated_at =
                options.updated_at || existing_binary.updated_at || updated_at;
            }
      ...
      { "./package.json": 20, "crypto-js/sha3": 18 },
    ],
    17: [
      function (require, module, exports) {
    ...
    20: [
      function (require, module, exports) {
        module.exports = {
          ...
          _requiredBy: ["/"],
          _resolved:
            "https://registry.npmjs.org/truffle-contract-schema/-/truffle-contract-schema-0.0.5.tgz",
