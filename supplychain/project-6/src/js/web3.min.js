          ...
          (d.prototype.encodeWithOffset = function (t, e, r, o) {
            ...
            if (c !== s) {
              ...
              if (e.isDynamicArray(u))
                for (var p = c === i ? 2 : 0, h = 0; h < r.length; h++)
                  c === i
                    ? (p += +r[h - 1][0] || 0)
                    : c === a && (p += +(r[h - 1] || [])[0] || 0),
                    (l += n.formatInputInt(o + h * f + 32 * p).encode());
              for (
                var d = c === i ? r.length - 1 : r.length, m = 0;
                m < d;
                m++
              ) {
                var y = l / 2;
                c === i
                  ? (l += this.encodeWithOffset(u, e, r[m + 1], o + y))
                  : c === a && (l += this.encodeWithOffset(u, e, r[m], o + y));
              }
              return l;
            }
            return r;
            ...
            if (this.isDynamicArray(r))
              return (function () {
                for (
                  ...
                  f.push(c.decode(t, i + l, a));
                return f;
              })();
            if (this.isStaticArray(r))
              return (function () {
                for (
                  var n = c.staticArrayLength(r),
                    o = e,
                    i = c.nestedName(r),
                    a = c.staticPartLength(i),
                    s = 32 * Math.floor((a + 31) / 32),
                    u = [],
                    f = 0;
                  f < n * s;
                  f += s
                )
                  u.push(c.decode(t, o + f, i));
                return u;
              })();
            if (this.isDynamicType(r))
              return (
                (n = parseInt("0x" + t.substr(2 * e, 64))),
                (i = parseInt("0x" + t.substr(2 * n, 64))),
                (a = Math.floor((i + 31) / 32)),
                (s = new o(t.substr(2 * n, 64 * (1 + a)), 0)),
                c._outputFormatter(s, r)
              );
      ...
      function (t, e, r) {
        var n = t("bignumber.js"),
          ...
          p = function (t) {
            return m((t = t || 0))
              ? t
              : !y(t) || (0 !== t.indexOf("0x") && 0 !== t.indexOf("-0x"))
      ...
      function (t, e, r) {
        ...
        function w(t) {
          (this._requestManager = new n(t)),
            ...
            (this.shh = new s(this)),
            (this.net = new c(this)),
            (this.personal = new u(this)),
            (this.bzz = new f(this)),
            (this.settings = new l()),
            (this.version = { api: p.version }),
            (this.providers = { HttpProvider: v, IpcProvider: b }),
            (this._extend = m(this)),
            this._extend({ properties: x() });
        }
        (w.providers = { HttpProvider: v, IpcProvider: b }),
          ...
          (w.prototype.BigNumber = _),
          (w.prototype.toHex = h.toHex),
          (w.prototype.toAscii = h.toAscii),
          (w.prototype.toUtf8 = h.toUtf8),
          (w.prototype.fromAscii = h.fromAscii),
          (w.prototype.fromUtf8 = h.fromUtf8),
          (w.prototype.toDecimal = h.toDecimal),
          (w.prototype.fromDecimal = h.fromDecimal),
          (w.prototype.toBigNumber = h.toBigNumber),
          (w.prototype.toWei = h.toWei),
          (w.prototype.fromWei = h.fromWei),
          (w.prototype.isAddress = h.isAddress),
          (w.prototype.isChecksumAddress = h.isChecksumAddress),
          (w.prototype.toChecksumAddress = h.toChecksumAddress),
          (w.prototype.isIBAN = h.isIBAN),
          (w.prototype.padLeft = h.padLeft),
          (w.prototype.padRight = h.padRight),
          (w.prototype.sha3 = function (t, e) {
            return "0x" + d(t, e);
          }),
        ...
        var x = function () {
          return [
            new g({ name: "version.node", getter: "web3_clientVersion" }),
            new g({
      ...
      function (t, e, r) {
        ...
        (u.prototype.encode = function (t) {
          ...
          (u.prototype.decode = function (t) {
            t.data = t.data || "";
            var e =
                a.isArray(t.topics) && a.isString(t.topics[0])
                  ? t.topics[0].slice(2)
                  : "",
          ...
          c = function (t, e) {
            return (
              t
                .filter(function (t) {
                  return (
                    "constructor" === t.type && t.inputs.length === e.length
                  );
                })
                .map(function (t) {
                    ...
                    t._eth.getTransactionReceipt(
                      ...
                      function (r, i) {
                        i &&
                          i.blockHash &&
                          !n &&
                          t._eth.getCode(i.contractAddress, function (r, a) {
                            if (!n && a)
                              if (
        ...
        (u.prototype.types = function (t) {
          ...
          (u.prototype.decode = function (t) {
            ...
            return (
              ...
              (s.address = t.address),
              (s.args = this._params.reduce(function (t, e) {
    ...
    29: [
      function (t, e, r) {
        ...
        (c.prototype.watch = function (t) {
          return (
            this.callbacks.push(t), this.filterId && (a(this, t), s(this)), this
          );
        }),
          ...
          (c.prototype.get = function (t) {
            ...
            return (
              null === this.filterId
                ...
                : this.implementation.getLogs(this.filterId, function (r, n) {
                    r
                      ? t(r)
                      : t(
                          null,
      ...
      function (t, e, r) {
        ...
        var n = t("../utils/utils"),
          ...
          a = function (t) {
            var e;
            if (void 0 !== t)
              return "latest" === (e = t) || "pending" === e || "earliest" === e
                ? t
                : n.toHex(t);
          },
          s = function (t) {
    ...
    38: [
      function (t, e, r) {
        ...
        var n = t("../formatters"),
          ...
          d = t("../transfer"),
          m = function (t) {
            return o.isString(t[0]) && 0 === t[0].indexOf("0x")
              ? "eth_getBlockByHash"
        ...
        var w = function () {
            ...
            return [
              ...
              new i({ name: "compile.lll", call: "eth_compileLLL", params: 1 }),
              new i({
                name: "compile.serpent",
                call: "eth_compileSerpent",
                params: 1,
              }),
              new i({ name: "submitWork", call: "eth_submitWork", params: 3 }),
              new i({ name: "getWork", call: "eth_getWork", params: 0 }),
            ];
          },
          x = function () {
            return [
              ...
              new a({ name: "protocolVersion", getter: "eth_protocolVersion" }),
            ];
          };
    ...
    40: [
      function (t, e, r) {
        ...
        var a = function () {
          ...
          s = function () {
            return [
              new o({ name: "listAccounts", getter: "personal_listAccounts" }),
            ];
          };
        e.exports = function (t) {
          this._requestManager = t._requestManager;
      ...
      function (t, e, r) {
        ...
        (o.prototype.setRequestManager = function (t) {
          ...
          (o.prototype.formatOutput = function (t) {
            return this.outputFormatter && null != t
                  ...
                  this.provider.sendAsync(s, function (t, e) {
                    if (!t) {
                      ...
                      e.map(function (t) {
                        ...
                        return (
                          !!u.polls[e] &&
                          ((t.callback = u.polls[e].callback), t)
                        );
                      })
                        .filter(function (t) {
                          return !!t;
            ...
            return (
              ...
              (r = this).requestManager.startPolling(
                ...
                function (t, e) {
                  ...
                  o.isObject(e) &&
                    e.startingBlock &&
                    (e = n.outputSyncingFormatter(e)),
                    r.callbacks.forEach(function (t) {
                      r.lastSyncState !== e &&
                        (!r.lastSyncState && o.isObject(e) && t(null, !0),
                        setTimeout(function () {
                          t(null, e);
                        }, 0),
                        (r.lastSyncState = e));
      ...
      function (t, e, r) {
        var n = t("./iban"),
          ...
          a = function (t, e, r, n, i, a) {
            var s = o;
            return t.contract(s).at(r).deposit(i, { from: e, value: n }, a);
          };
                ...
                !(function () {
                  ...
                  for (e = 0; e < 256; e++) {
                    ...
                    (a[r] = (v << 24) | (v >>> 8)),
                      ...
                      (u[r] = v);
                    v =
                      (16843009 * g) ^ (65537 * y) ^ (257 * m) ^ (16843008 * r);
                    (f[d] = (v << 24) | (v >>> 8)),
                      (l[d] = (v << 16) | (v >>> 16)),
                      (p[d] = (v << 8) | (v >>> 24)),
                      (h[d] = v),
                      r
                        ? ((r = m ^ t[t[t[g ^ m]]]), (n ^= t[t[n]]))
                        : (r = n = 1);
                  }
                })();
              ...
              (v = (r.kdf = {}).OpenSSL =
                {
                  execute: function (t, e, r, n) {
                    n || (n = i.random(8));
                    var o = u.create({ keySize: e + r }).compute(t, n),
                      a = i.create(o.words.slice(e), 4 * r);
                    return (
                      (o.sigBytes = 4 * e), m.create({ key: o, iv: a, salt: n })
                    );
                  },
                }),
              (b = n.PasswordBasedCipher =
                g.extend({
                ...
                var n = (e.Encryptor = e.extend({
                  processBlock: function (t, e) {
                    var n,
                      ...
                      s = this._counter;
                    a &&
                      ((s = this._counter = a.slice(0)), (this._iv = void 0)),
                      0 === ((n = s)[0] = r(n[0])) && (n[1] = r(n[1]));
                    var c = s.slice(0);
                    o.encryptBlock(c, 0);
                ...
                n.extend({
                  ...
                  compute: function (t, e) {
                    for (
                      ...
                      n.reset();
                      for (
                        var h = p.words, d = h.length, m = p, y = 1;
                        y < l;
                        y++
                      ) {
                      ...
                      for (p = 0; p < 5; p++)
                        for (m = 0; m < 5; m++) {
                          var F = r[(w = p + 5 * m)],
                            ...
                            I = l[((p + 1) % 5) + 5 * m],
                            N = l[((p + 2) % 5) + 5 * m];
                          (F.high = O.high ^ (~I.high & N.high)),
                            (F.low = O.low ^ (~I.low & N.low));
                        }
                      F = r[0];
                      var T = f[s];
                    ...
                    for (
                      ...
                      (U = z),
                        ...
                        (O =
                          (kt +
                            (yt + dt + (Bt >>> 0 < gt >>> 0 ? 1 : 0)) +
                            ((I = (lt + Bt) | 0) >>> 0 < lt >>> 0 ? 1 : 0)) |
                          0);
                    }
                    (d = n.low = d + I),
                      (n.high = h + O + (d >>> 0 < I >>> 0 ? 1 : 0)),
                      (y = o.low = y + T),
                      (o.high = m + N + (y >>> 0 < T >>> 0 ? 1 : 0)),
                      (v = i.low = v + D),
                      (i.high = g + P + (v >>> 0 < D >>> 0 ? 1 : 0)),
                      (_ = a.low = _ + E),
                      (a.high = b + R + (_ >>> 0 < E >>> 0 ? 1 : 0)),
                      (x = s.low = x + H),
                      (s.high = w + M + (x >>> 0 < H >>> 0 ? 1 : 0)),
                      (B = f.low = B + q),
                      (f.high = k + j + (B >>> 0 < q >>> 0 ? 1 : 0)),
                      (A = l.low = A + L),
                      (l.high = S + z + (A >>> 0 < L >>> 0 ? 1 : 0)),
                      (F = p.low = F + W),
                      (p.high = C + U + (F >>> 0 < W >>> 0 ? 1 : 0));
                  },
                  _doFinalize: function () {
                    var t = this._data,
                      e = t.words,
      ...
      function (t, e, r) {
        !(function (t) {
          ...
          function m() {
            ...
            if (224 == (240 & t)) {
              if ((e = ((15 & t) << 12) | (d() << 6) | d()) >= 2048)
                return l(e), e;
              throw Error("Invalid continuation byte");
            }
            if (
              240 == (248 & t) &&
              (e = ((7 & t) << 18) | (d() << 12) | (d() << 6) | d()) >= 65536 &&
              e <= 1114111
            )
              return e;
          ...
          var y = {
            version: "2.1.2",
            encode: function (t) {
              for (var e = f(t), r = e.length, n = -1, o = ""; ++n < r; )
                o += h(e[n]);
              return o;
            },
            decode: function (t) {
        ...
        !(function (t) {
          ...
          function w(t, e, r) {
            for (var n, o, i = [0], a = 0, s = t.length; a < s; ) {
              ...
              for (i[(n = 0)] += u.indexOf(t.charAt(a++)); n < i.length; n++)
                i[n] > r - 1 &&
                  (null == i[n + 1] && (i[n + 1] = 0),
                  (i[n + 1] += (i[n] / r) | 0),
                  (i[n] %= r));
          ...
          ((r = (function t(e) {
            ...
            function X(t, e) {
              ...
              if (!(d instanceof X))
                return (
                  L && tt(26, "constructor call without new", t), new X(t, e)
                );
              if (null != e && U(e, 2, 64, P, "base")) {
                if (((h = t + ""), 10 == (e |= 0)))
                  return et(
                    (d = new X(t instanceof X ? t : h)),
                    E + d.e + 1,
                    M
                  );
                if (
                  ...
                  return S(d, h, s, e);
                s
                  ? ((d.s = 1 / t < 0 ? ((h = h.slice(1)), -1) : 1),
                    L && h.replace(/^0\.0*|\./, "").length > 15 && tt(P, c, t),
                    (s = !1))
              ...
              if ((h = h.slice(a, f + 1)))
                if (
                  ...
                  if (
                    ...
                    for (a && d.c.push(+h.slice(0, a)), f -= l; a < f; )
                      d.c.push(+h.slice(a, (a += l)));
              ...
              for (
                n < 37 && (t = t.toLowerCase()),
                  h >= 0 &&
                    ...
                    (K = 0),
                    (t = t.replace(".", "")),
                    (f = (p = new X(n)).pow(t.length - h)),
                    (K = s),
                    (p.c = w(k(g(f.c), f.e), 10, e)),
                    (p.e = p.c.length)),
                  a = s = (l = w(t, n, e)).length;
                0 == l[--s];
                l.pop()
              );
              if (!l[0]) return "0";
            ...
            function V(t, e, r, n) {
              var o, i, a, c, u;
              if (((r = null != r && U(r, 0, 8, n, s) ? 0 | r : M), !t.c))
                return t.toString();
              if (((o = t.c[0]), (a = t.e), null == e))
                (u = g(t.c)),
                  (u = 19 == n || (24 == n && a <= H) ? x(u, a) : k(u, a));
              else if (
                ((i = (t = et(new X(t), e, r)).e),
                (c = (u = g(t.c)).length),
                19 == n || (24 == n && (e <= i || i <= H)))
              ) {
                for (; c < e; u += "0", c++);
              ...
              return (
                (t < e || t > r || t != B(t)) &&
                  tt(
                    n,
                    (o || "decimal places") +
                      (t < e || t > r ? " out of range" : " not an integer"),
                    t
                  ),
                !0
              );
            ...
            return (
                ...
                function () {
                  ...
                  return (
                    s((e = "DECIMAL_PLACES")) &&
                      ...
                      (E = 0 | t),
                    (n[e] = E),
                    s((e = "ROUNDING_MODE")) && U(t, 0, 8, 2, e) && (M = 0 | t),
                    (n[e] = M),
                    s((e = "EXPONENTIAL_AT")) &&
                      (_(t)
                        ? U(t[0], -m, 0, 2, e) &&
                      ...
                      (!0 === t || !1 === t || 1 === t || 0 === t
                        ? t
                          ? !(t = "undefined" == typeof crypto) &&
                            ...
                            ? (W = !0)
                            : L
                            ? tt(2, "crypto unavailable", t ? void 0 : crypto)
                            : (W = !1)
                          : (W = !1)
                        : L && tt(2, e + a, t)),
                    (n[e] = W),
                    s((e = "MODULO_MODE")) && U(t, 0, 9, 2, e) && (J = 0 | t),
                    (n[e] = J),
                    s((e = "POW_PRECISION")) && U(t, 0, m, 2, e) && (K = 0 | t),
                    (n[e] = K),
                    s((e = "FORMAT")) &&
                      ("object" == typeof t
                        ? (G = t)
                        : L && tt(2, e + " not an object", t)),
                    (n[e] = G),
                    n
                  );
                }),
              ...
              (X.random =
                ...
                function (t) {
                  var e,
                    ...
                    f = new X(R);
                  if (
                    ((t = null != t && U(t, 0, m, 14) ? 0 | t : E),
                    (a = o(t / l)),
                    W)
                  )
                    if (crypto.getRandomValues) {
                      for (
                        e = crypto.getRandomValues(new Uint32Array((a *= 2)));
                        c < a;

                      )
                        (s = 131072 * e[c] + (e[c + 1] >>> 11)) >= 9e15
                      ...
                      for (e = crypto.randomBytes((a *= 7)); c < a; )
                        (s =
                  ...
                  if (!W)
                    for (; c < a; ) (s = C()) < 9e15 && (u[c++] = s % 1e14);
                  for (
                    a = u[--c],
                      t %= l,
                      a && t && ((s = h[l - t]), (u[c] = i(a / s) * s));
                    0 === u[c];
                    u.pop(), c--
                  );
                  if (c < 0) u = [(n = 0)];
                    ...
                    do {
                      if (((m = 0), (u = e(N, w, C, x)) < 0)) {
                        ...
                        if (
                          ...
                          for (; e(N, w, C, x) < 1; )
                            m++, r(w, C < x ? F : N, x, c), (x = w.length);
                      } else 0 === u && (m++, (w = [0]));
                      (_[h++] = m),
                        w[0] ? (w[x++] = I[B] || 0) : ((w = [I[B]]), (x = 1));
              ...
              (S = function (t, e, r, n) {
                ...
                if (N.test(i)) t.s = isNaN(i) ? null : i < 0 ? -1 : 1;
                  ...
                  if (
                    ...
                    n && ((o = n), (i = i.replace(O, "$1").replace(I, "0.$1"))),
                    e != i)
                  )
                    return new X(i, o);
                  L && tt(P, "not a" + (n ? " base " + n : "") + " number", e),
                    (t.s = null);
                }
                (t.c = t.e = null), (P = 0);
              }),
              ...
              (D.decimalPlaces = D.dp =
                function () {
                  ...
                  if (!r) return null;
                  if (
                    ((t = ((e = r.length - 1) - y(this.e / l)) * l), (e = r[e]))
                  )
                    for (; e % 10 == 0; e /= 10, t--);
                  return t < 0 && (t = 0), t;
                }),
              ...
              (D.dividedToIntegerBy = D.divToInt =
                function (t, e) {
              ...
              (D.minus = D.sub =
                function (t, e) {
                  ...
                  if (!c || !u) {
                    if (!p || !h)
                      return p ? ((t.s = -e), t) : new X(h ? a : NaN);
                    if (!p[0] || !h[0])
                      return h[0]
                        ? ((t.s = -e), t)
                        : new X(p[0] ? a : 3 == M ? -0 : 0);
                ...
                function (t) {
                  ...
                  if (
                    (null != t &&
                      ...
                      1 !== t &&
                      0 !== t &&
                      (L && tt(13, "argument" + a, t), t != !!t && (t = null)),
                    !n)
                  )
                    return null;
              ...
              (D.squareRoot = D.sqrt =
                function () {
                  ...
                  if (
                    (0 == (c = Math.sqrt(+a)) || c == 1 / 0
                      ? (((e = g(s)).length + u) % 2 == 0 && (e += "0"),
                        (c = Math.sqrt(e)),
                        (u = y((u + 1) / 2) - (u < 0 || u % 2)),
                        (n = new X(
                          (e =
                    ...
                    for ((c = (u = n.e) + f) < 3 && (c = 0); ; )
                      if (
                        ((i = n),
                        (n = l.times(i.plus(r(a, i, f, 1)))),
                        g(i.c).slice(0, c) === (e = g(n.c)).slice(0, c))
                      ) {
                        if (
                          (n.e < u && --c,
                          ...
                          (+e && (+e.slice(1) || "5" != e.charAt(0))) ||
                            (et(n, n.e + E + 2, 1), (t = !n.times(n).eq(a)));
                          break;
                        }
              ...
              (D.times = D.mul =
                function (t, e) {
                  ...
                  for (
                    n = y(w.e / l) + y(t.e / l),
                      t.s *= w.s,
                      (c = x.length) < (h = k.length) &&
                        ((v = x), (x = k), (k = v), (o = c), (c = h), (h = o)),
                      o = c + h,
                      v = [];
                    o--;
                    v.push(0)
              ...
              (D.toDigits = function (t, e) {
                var r = new X(this);
                return (
                  (t = null != t && U(t, 1, m, 18, "precision") ? 0 | t : null),
                  (e = null != e && U(e, 0, 8, 18, s) ? 0 | e : M),
                  t ? et(r, t, e) : r
                );
              }),
              ...
              (D.toFixed = function (t, e) {
                return V(
                  this,
                  null != t && U(t, 0, m, 20) ? ~~t + this.e + 1 : null,
                  e,
                  20
                );
              }),
              (D.toFormat = function (t, e) {
                var r = V(
                  this,
                  null != t && U(t, 0, m, 21) ? ~~t + this.e + 1 : null,
                  e,
                  21
                );
                if (this.c) {
                  var n,
                    ...
                    p = l.length;
                  if (
                    (a && ((n = i), (i = a), (a = n), (p -= n)), i > 0 && p > 0)
                  ) {
                    for (n = p % i || i, c = l.substr(0, n); n < p; n += i)
                      c += s + l.substr(n, i);
                ...
                if (
                  (null != t &&
                    ...
                    ((p = s.isInt()) && !s.lt(R)) ||
                      ...
                      (t = !p && s.c && et(s, s.e + 1, 1).gte(R) ? s : null))),
                  !m)
                )
                  return d.toString();
                for (
                  f = g(m),
                    i = y.e = f.length - d.e - 1,
                    y.c[0] = h[(a = i % l) < 0 ? l + a : a],
                    t = !t || s.cmp(y) > 0 ? (i > 0 ? y : v) : s,
                    a = z,
                    z = 1 / 0,
                    s = new X(f),
                    c.c[0] = 0;
                  (u = r(s, y, 0, 1)), 1 != (o = n.plus(u.times(b))).cmp(t);

                )
                  (n = b),
                    (b = o),
                    (v = c.plus(u.times((o = v)))),
                    (c = o),
                    (y = s.minus(u.times((o = y)))),
                    (s = o);
                return (
                  (o = r(t.minus(n), b, 0, 1)),
                  (c = c.plus(o.times(v))),
              ...
              (D.toPower = D.pow =
                function (t, e) {
                  ...
                  if (
                    ...
                    return (r = Math.pow(+c, t)), new X(e ? r % e : r);
                  for (
                    e
                      ? t > 1 && c.gt(R) && c.isInt() && e.gt(R) && e.isInt()
                        ? (c = c.mod(e))
                        : ((a = e), (e = null))
                      : K && (r = o(K / l + 2)),
                      n = new X(R);
                  ...
                  return e
                    ? n
                    : (t < 0 && (n = R.div(n)),
                      a ? n.mod(a) : r ? et(n, K, M) : n);
                }),
              (D.toPrecision = function (t, e) {
                return V(
                  this,
                  null != t && U(t, 1, m, 24, "precision") ? 0 | t : null,
                  e,
                  24
                );
              }),
