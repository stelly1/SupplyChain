...
contract SupplyChain is ConsumerRole, DistributorRole, FarmerRole, RetailerRole, Ownable {
  ...
  /* modifier onlyOwner() override {
    require(msg.sender == addingOwner);
    _;
  } */
  ...
  modifier harvested(uint _upc) {
    require(items[_upc].itemState == State.Harvested, "N/A to harvest caffeine beans");
    _;
  }

  // Define a modifier that checks if an item.state of a upc is Processed
  modifier processed(uint _upc) {
    require(items[_upc].itemState == State.Processed, "N/A to process caffeine beans");
    _;
  }
  
  // Define a modifier that checks if an item.state of a upc is Packed
  modifier packed(uint _upc) {
    require(items[_upc].itemState == State.Packed, "N/A to pack caffeine beans");
    _;
  }

  // Define a modifier that checks if an item.state of a upc is ForSale
  modifier forSale(uint _upc) {
    require(items[_upc].itemState == State.ForSale, "N/A to put up for sale caffeine beans");
    _;
  }

  // Define a modifier that checks if an item.state of a upc is Sold
  modifier sold(uint _upc) {
    require(items[_upc].itemState == State.Sold, "N/A, caffeine beans not sold");
    _;
  }
  
  // Define a modifier that checks if an item.state of a upc is Shipped
  modifier shipped(uint _upc) {
    require(items[_upc].itemState == State.Shipped, "N/A to ship caffeine beans");
    _;
  }

  // Define a modifier that checks if an item.state of a upc is Received
  modifier received(uint _upc) {
    require(items[_upc].itemState == State.Received, "N/A to receive caffeine beans");
    _;
  }

  // Define a modifier that checks if an item.state of a upc is Purchased
  modifier purchased(uint _upc) {
    require(items[_upc].itemState == State.Purchased, "N/A to purchase caffeine beans");
    _;
  }
  ...
  //@udacity mentor - is this necessary in this circumstance?
  /* function kill() public {
    if (msg.sender == addingOwner) {
      selfdestruct(addingOwner);
    }
  } */
